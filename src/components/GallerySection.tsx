...
export function GallerySection() {
  ...
  return (
    ...
    >
      ...
      {/* Sky blue aurora in corner */}
      <motion.div
        className="absolute -top-20 -right-20 w-96 h-96 rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(56,189,248,0.12) 0%, transparent 70%)', filter: 'blur(50px)' }}
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="w-1.5 h-1.5 rounded-full" style={{ background: '#D4AF6E' }} />
          ...
          {config.gallery.images.map((image, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ background: 'linear-gradient(to top, rgba(15,37,87,0.65) 0%, transparent 60%)' }}
              />
              {/* Sky blue top-left corner accent */}
              <div className="absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2" style={{ borderColor: 'rgba(56,189,248,0.8)' }} />
              {/* Gold bottom-right corner accent */}
              <div className="absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2" style={{ borderColor: 'rgba(212,175,110,0.7)' }} />
            </motion.div>
          ))}
        </div>
      </div>
