...
export function EnvelopeIntro({ onOpen }: EnvelopeIntroProps) {
  ...
  // تصحيح الـ transition - استخدام string للـ ease بدلاً من array
  const getAnimationTransition = () => ({
    duration: isMobile ? 1.2 : 1.4,
    ease: "easeInOut" as const, // استخدام string بدلاً من array
  });

  // أو يمكن استخدام spring transition لحركة أكثر واقعية
  // const getSpringTransition = () => ({
  //   type: "spring" as const,
  //   damping: 25, // تحكم في الارتداد
  //   stiffness: 80, // تحكم في الصلابة
  //   duration: isMobile ? 1.2 : 1.4,
  // });
