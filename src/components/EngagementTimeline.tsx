      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            ...
            <div
              ...
              style={{ background: theme.ornament.solid, opacity: 0.5 }}
            />
            <div
              className="h-px w-10 sm:w-16"
              style={{
         ...
         <div className="relative">
          ...
          <motion.div
            ...
            style={{
              background: `linear-gradient(to bottom, transparent, ${theme.ornament.half} 10%, ${theme.ornament.half} 90%, transparent)`,
            }}
            ...
            {events.map((event, i) => {
              ...
              return (
                ...
                >
                  {/* Left side */}
                  <div
                    className={`w-1/2 ${isLeft ? "pr-10 text-end" : "pl-10"}`}
                  >
        ...
        >
          <div
            ...
            style={{
              background: `linear-gradient(to right, transparent, ${theme.ornament.soft})`,
            }}
          />
          <div
            className="w-1.5 h-1.5 rotate-45 border"
            style={{ borderColor: theme.ornament.soft }}
          />
          <div
            className="h-px w-16 sm:w-24"
            style={{
              background: `linear-gradient(to left, transparent, ${theme.ornament.soft})`,
            }}
          />
        </motion.div>
      </div>
