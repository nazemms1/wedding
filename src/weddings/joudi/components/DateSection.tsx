  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none" aria-hidden="true">
        <motion.div className="w-175 h-175 rounded-full" style={{ border: '1px solid rgba(212,175,110,0.06)' }}
          animate={{ rotate: 360 }} transition={{ duration: 40, repeat: Infinity, ease: 'linear' }} />
        <motion.div className="absolute w-125 h-125 rounded-full" style={{ border: '1px solid rgba(212,175,110,0.04)' }}
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        {isPast ? (
          <div className="flex flex-col items-center gap-6">
            ...
            <motion.p className="text-xs tracking-[0.45em] uppercase" style={{ color: theme.color.gold, fontFamily: theme.font.body }}
            ...
            <motion.div className="flex items-center gap-3" initial={{ scaleX: 0 }} animate={inView ? { scaleX: 1 } : {}} transition={{ delay: 0.75, duration: 0.8 }}>
              ...
              <motion.div className="w-2 h-2 rotate-45" style={{ background: theme.color.gold }}
          ...
          <div className="flex items-start justify-center gap-3 sm:gap-5 md:gap-7 flex-wrap">
            {boxes.map((box, i) => (
              <div key={box.label} className="flex items-start gap-3 sm:gap-5 md:gap-7">
                <CountdownBox value={box.value} label={box.label} delay={0.4 + i * 0.12} inView={inView} />
                {i < boxes.length - 1 && (
                  <motion.span className="text-3xl mt-7 sm:mt-9" style={{ color: theme.color.gold, opacity: 0.5 }}
