  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <motion.p className="text-xs tracking-[0.45em] uppercase mb-6 text-center" style={{ color: theme.color.gold, fontFamily: theme.font.body }}
        ...
        <motion.div
          ...
          <div className="flex items-center justify-between px-5 py-3" style={{ borderBottom: `1px solid ${theme.ornament.soft}` }}>
