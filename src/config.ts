...
export const config: SiteConfig = {
  ...
  gallery: {
    images: [
      { src: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=800&q=80', alt: 'Couple walking together' },
      { src: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=800&q=80', alt: 'Wedding rings' },
      { src: 'https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=800&q=80', alt: 'Romantic moment' },
      { src: 'https://images.unsplash.com/photo-1606216794079-73f76fbf9d7f?w=800&q=80', alt: 'Couple portrait' },
    ],
  },
  video: {
    src: '/video/hero.mp4',
