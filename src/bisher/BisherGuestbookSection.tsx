...
function MessageCard({
  ...
  inView: boolean;
  theme: {
    card: { bg: string; border: string; topBar: string };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: theme.card.topBar }}
      />
      <div
      ...
      <div className="flex items-center gap-3">
        <div
          className="w-9 h-9 rounded-full flex items-center justify-center text-sm font-semibold flex-0"
          style={{
        ...
        <span
          ...
          style={{ color: theme.color.skyBlue, fontFamily: theme.font.body }}
        >
          {msg.name}
        </span>
      </div>
...
export function BisherGuestbookSection() {
  ...
  const [messages, setMessages] = useState<GuestMessage[]>(() =>
    config.guestbook.seedMessages.map((m, i) => ({
      id: i + 1,
      name: m.name,
      message: m.message,
    })),
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `url(${config.sectionImages.guestbook})`,
      ...
      {[
        ...
        >
          <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
            <path
              d={c.d1}
              stroke={theme.ornament.solid}
              strokeWidth="1.5"
              opacity={theme.corner.strokeOpacity}
            />
            <path
              d={c.d2}
              stroke={theme.ornament.solid}
              strokeWidth="0.8"
              opacity={theme.corner.innerStrokeOpacity}
            />
            <circle
              cx={c.cx}
              cy={c.cy}
              r="2"
              fill={theme.ornament.solid}
              opacity={theme.corner.dotOpacity}
            />
          </svg>
        </motion.div>
      ))}
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-8">
            <div
              ...
              style={{
                background: `linear-gradient(to right, transparent, ${theme.ornament.skyHalf})`,
              }}
            />
            <div
            ...
            <div
              className="h-px w-10 sm:w-16"
              style={{
                background: `linear-gradient(to left, transparent, ${theme.ornament.skyHalf})`,
              }}
            />
          </div>
          <motion.p
          ...
          >
            <div
              className="h-px w-20"
              style={{
                background: `linear-gradient(to right, transparent, ${theme.ornament.mid})`,
              }}
            />
            <motion.svg
              width="18"
            ...
            <div
              className="h-px w-20"
              style={{
                background: `linear-gradient(to left, transparent, ${theme.ornament.mid})`,
              }}
            />
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div
            ...
            style={{ borderColor: theme.ornament.skySoft }}
          />
          <div
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                style={{
                  ...
                  border: `1px solid ${theme.card.border}`,
                  color: theme.color.textOnDark,
                  caretColor: theme.color.skyBlue,
                  fontFamily: theme.font.body,
                }}
                onFocus={(e) =>
                  (e.target.style.borderColor = theme.color.skyBlue)
                }
              ...
              >
                {submitting ? (
                  <motion.span
                    ...
                    style={{
                      borderColor: `${theme.color.skyBlue}40`,
                      borderTopColor: theme.color.skyBlue,
                    }}
                    animate={{ rotate: 360 }}
                    transition={{
                      duration: 0.8,
        ...
        {messages.length > 0 && (
          <div>
            ...
            >
              {messages.length}{" "}
              {messages.length === 1 ? t.wishesShared : t.wishesSharedPlural}
            </motion.p>
        ...
        >
          <div
            ...
            style={{
              background: `linear-gradient(to right, transparent, ${theme.ornament.skySoft})`,
            }}
          />
          <div
          ...
          <div
            className="h-px w-16 sm:w-24"
            style={{
              background: `linear-gradient(to left, transparent, ${theme.ornament.skySoft})`,
            }}
          />
        </motion.div>
      </div>
